...
// Defines a one-to-many relationship where one taskList can have many tasks.
// When a taskList is saved or deleted, its associated tasks are also persisted or removed due to the cascade settings.
